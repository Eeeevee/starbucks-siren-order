...
public class StarbucksSirenOrder {
    ...
    private static void displayMainMenu() {
        System.out.println("*STARBUCKS main.java.Order*\n");

        System.out.println("[main.java.Menu]");
        List<Menu> mainMenus = menuCategory.getMenus("Main");
        int nextNum = printMenu(mainMenus, 1);

        System.out.println("[main.java.Order]");
        List<Menu> orderMenus = menuCategory.getMenus("main.java.Order");    // 메뉴 컨텍스트에서 주문메뉴 조회
    ...
    private static void handleMainMenuInput() {
        ...
        int orderMenuSize = menuCategory.getMenus("main.java.Order").size();    // 주문메뉴 사이즈 조회
